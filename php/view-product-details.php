  ...
  <div class="container">
    <div class="card">
      ...
      <div class="container-fliud">
        <div class="wrapper row">
          <div class="preview col-md-6">
            ...
            <div class="preview-pic tab-content">
              <div class="tab-pane active" id="pic-1"><img src="../php/<?php echo $path["image_path"]; ?>" /></div>
          ...
          <div class="details col-md-6">
            ...
            <div class="action">
              ...
              <input type="submit" value="Add to wishlist" class="add-to-cart btn btn-default" />
    	...
    	<!-- <div class="">
          <form method="post" action="../php/manage-wishlist.php?action=add&utility_id=<?php echo $item_details["utility_id"]; ?>">
            <img class="pic" height="100" width="120" src="../php/<?php echo $path["image_path"]; ?>">
            <div><strong><?php echo $item_details["name"]; ?></strong></div>
            ...
            <div><strong>Seller's Name: </strong><strong><?php echo "".$seller_details["firstname"]." ".$seller_details["lastname"]; ?></strong></div>
            <div><strong>Description: </strong><strong><?php  echo "".$item_details["description"]; ?></strong></div>
            <div><strong>Category: </strong><strong><?php  echo "".$category_details["name"]; ?></strong></div>          
          </form>
      </div> -->
</body>
</html>